...
for i in file_list_train:
    ...
    july_image= image [0:3,:,:]
    #image_rescale=img_trans/255
    image_t=july_image.transpose(2,1,0)
    image_resized = resize(image_t, (220,600,4),anti_aliasing=False)
...
first_model = DenseNet121(weights = None, input_shape=(220, 600, 4), include_top=False)
...
def get_resnet152v2(input_shape, learning_rate):
    ...
    resnet_152_v2_model = ResNet152V2(include_top=False, weights= None, input_shape=(220, 600, 4))
