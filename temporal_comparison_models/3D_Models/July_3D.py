...
train_data=np.stack((july_stack,july_stack), axis=0)
...
#sep1_stack=np.stack(sept1_resize_list, axis=0)
#sep2_stack=np.stack(sept2_resize_list, axis=0)
val_data=np.stack((july_stack,july_stack), axis=0)
#val_data=np.stack(resize_list, axis=0)
...
#sep1_stack=np.stack(sept1_resize_list, axis=0)
#sep2_stack=np.stack(sept2_resize_list, axis=0)
test_data=np.stack((july_stack,july_stack), axis=0)
#val_data=np.stack(resize_list, axis=0)
...
model = Sequential()
model.add(layers.Conv3D(32,(2,2,2),activation='relu',input_shape=(2,220, 600, 4),bias_initializer=Constant(0.01)))
...
#sep1_stack=np.stack(sept1_resize_list, axis=0)
#sep2_stack=np.stack(sept2_resize_list, axis=0)
aug_test_data=np.stack((aug1_stack, aug2_stack), axis=0)
#val_data=np.stack(resize_list, axis=0)
aug_test_data=aug_test_data.transpose(1,0,2,3,4)
print(aug_test_data.shape)
...
plt.subplot(411)
plt.title('Image 10')
plt.imshow(aug_test_data[1,0,:,:,0],cmap='gray')

plt.subplot(412)
plt.title('Image 20')
plt.imshow(aug_test_data[1,0,:,:,1],cmap='gray')

plt.subplot(413)
plt.title('Image 30')
plt.imshow(aug_test_data[2,1,:,:,0],cmap='gray')

plt.subplot(414)
plt.title('Image 40')
plt.imshow(aug_test_data[2,1,:,:,1],cmap='gray')

plt.savefig(r'D:\soybean_yield\figures\aug_3D_test_image_stack.png', dpi=300,bbox_inches='tight')
plt.show()
...
## Get training and testing loss and accuracy
dense_test_loss_1, dense_test_acc_1 = model.evaluate(aug_test_data,y_test)
...
y_pred_dense_test = model.predict(aug_test_data)
...
#aug1_stack=np.stack(aug1_resize_list, axis=0)
#aug2_stack=np.stack(aug2_resize_list, axis=0)
sept1_stack=np.stack(sept1_resize_list, axis=0)
sept2_stack=np.stack(sept2_resize_list, axis=0)
sept_test_data=np.stack((sept1_stack, sept2_stack), axis=0)
#val_data=np.stack(resize_list, axis=0)
sept_test_data=sept_test_data.transpose(1,0,2,3,4)
print(sept_test_data.shape)
...
plt.subplot(411)
plt.title('Image 10')
plt.imshow(sept_test_data[1,0,:,:,0],cmap='gray')

plt.subplot(412)
plt.title('Image 20')
plt.imshow(sept_test_data[1,0,:,:,1],cmap='gray')

plt.subplot(413)
plt.title('Image 30')
plt.imshow(sept_test_data[2,1,:,:,0],cmap='gray')

plt.subplot(414)
plt.title('Image 40')
plt.imshow(sept_test_data[2,1,:,:,1],cmap='gray')

plt.savefig(r'D:\soybean_yield\figures\sept_3D_test_image_stack.png', dpi=300,bbox_inches='tight')
plt.show()
...
## Get training and testing loss and accuracy
dense_test_loss_1, dense_test_acc_1 = model.evaluate(sept_test_data,y_test)
...
y_pred_dense_test = model.predict(sept_test_data)
