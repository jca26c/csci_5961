...
import pandas as pd
yield_df = pd.read_csv(r'D:\soybean_yield\csv\yield_result_parrot_sequioa.csv')
...
plt.subplot(412)
plt.title('Image 20')
plt.imshow(train_data[20,:,:,4],cmap='gray')
...
plt.subplot(414)
plt.title('Image 40')
plt.imshow(train_data[90,:,:,19],cmap='gray')
...
plt.subplot(414)
plt.title('Image 40')
plt.imshow(val_data[40,:,:,19],cmap='gray')
...
first_model = DenseNet121(weights = None, input_shape=(220, 600, 20), include_top=False)
...
def get_resnet152v2(input_shape, learning_rate):
    ...
    resnet_152_v2_model = ResNet152V2(include_top=False, weights= None, input_shape=(220, 600, 20))
