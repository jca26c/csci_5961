...
plt.subplot(413)
plt.title('Image 30')
plt.imshow(train_data[300,:,:,2],cmap='gray')

plt.subplot(414)
plt.title('Image 40')
plt.imshow(train_data[900,:,:,4],cmap='gray')
...
plt.subplot(412)
plt.title('Image 20')
plt.imshow(val_data[10,:,:,4],cmap='gray')
...
plt.subplot(414)
plt.title('Image 40')
plt.imshow(val_data[90,:,:,19],cmap='gray')
...
## Predict on train and test data
y_pred_res_train = model2.predict(train_img_pca_2d)
y_pred_res_test = model2.predict(test_img_pca_2d)
