...
plt.tight_layout()
plt.savefig(r'D:\soybean_yield\figures\dense_model_stack_3D_altum.png', dpi=300,bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig(r'D:\soybean_yield\figures\dense_stack_residual_plots_3D_altum.png', dpi=300,bbox_inches='tight')
plt.show()
